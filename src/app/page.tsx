...
export default async function Home() {
    // todo: pull up data from somewhere more dynamic
    // todo: migrate away from this file structure
    // const file = await fs.readFile(process.cwd() + '/app/job-hunting-test-data.csv', 'utf8');
